...
if (
  ((function (t, e) {
    ...
    function c(t, e, i, n) {
      var r;
      try {
        t && ft.isFunction((r = t.promise))
          ? r.call(t).done(e).fail(i)
          : t && ft.isFunction((r = t.then))
          ? r.call(t, e, i)
    ...
    function f(t, e, i) {
      ...
      if (void 0 === i && 1 === t.nodeType)
        if (
          ((n = "data-" + e.replace(Qt, "-$&").toLowerCase()),
    ...
    function y(t, e) {
      for (var i, n, r = [], o = 0, s = t.length; o < s; o++)
        (n = t[o]).style &&
          ...
          e
            ? ("none" === i &&
                ((r[o] = kt.get(n, "display") || null),
                r[o] || (n.style.display = "")),
              "" === n.style.display && Mt(n) && (r[o] = m(n)))
            : "none" !== i && ((r[o] = "none"), kt.set(n, "display", i)));
      ...
      return (
        (i =
          void 0 !== t.getElementsByTagName
            ...
            : []),
        void 0 === e || (e && r(t, e)) ? ft.merge([t], i) : i
      );
    }
    function _(t, e) {
    ...
    function b(t, e, i, n, r) {
      ...
      for (h.textContent = "", p = 0; (o = d[p++]); )
        if (n && ft.inArray(o, n) > -1) r && r.push(o);
          ...
          ((u = ft.contains(o.ownerDocument, o)),
        ...
        if (
          ...
          for (r in (delete s.handle, (s.events = {}), u))
            for (i = 0, n = u[r].length; i < n; i++)
              ft.event.add(e, r, u[r][i]);
        Lt.hasData(t) &&
          ((a = Lt.access(t)), (l = ft.extend({}, a)), Lt.set(e, l));
      }
    }
    function A(t, e) {
      var i = e.nodeName.toLowerCase();
      "input" === i && Bt.test(t.type)
        ? (e.checked = t.checked)
        : ("input" !== i && "textarea" !== i) ||
    ...
    function D(t, e, n, r) {
      ...
      if (
        d &&
        ((s = (o = b(e, t[0].ownerDocument, !1, t, r)).firstChild),
        1 === o.childNodes.length && (o = s),
        s || r)
      ) {
        for (l = (a = ft.map(v(o, "script"), P)).length; h < d; h++)
          (u = o),
            h !== p &&
              ((u = ft.clone(u, !0, !0)), l && ft.merge(a, v(u, "script"))),
            n.call(t[h], u, h);
        if (l)
          for (
            c = a[a.length - 1].ownerDocument, ft.map(a, S), h = 0;
            h < l;
            h++
          )
            (u = a[h]),
              $t.test(u.type || "") &&
                !kt.access(u, "globalEval") &&
                ft.contains(c, u) &&
                (u.src
                  ? ft._evalUrl && ft._evalUrl(u.src)
                  : i(u.textContent.replace(ne, ""), c));
      }
      return t;
    }
    function O(t, e, i) {
      for (var n, r = e ? ft.filter(e, t) : t, o = 0; null != (n = r[o]); o++)
        i || 1 !== n.nodeType || ft.cleanData(v(n)),
          n.parentNode &&
            (i && ft.contains(n.ownerDocument, n) && _(v(n, "script")),
        ...
        e ||
          (e = ft.cssProps[t] =
            (function k(t) {
              if (t in de) return t;
              for (
                var e = t[0].toUpperCase() + t.slice(1), i = he.length;
                i--;
    ...
    function Q(t, e, i, n, r) {
      ...
      for (
        ...
        "margin" === i && (s += ft.css(t, i + Wt[o], !0, r)),
          n
            ? ("content" === i && (s -= ft.css(t, "padding" + Wt[o], !0, r)),
              "margin" !== i &&
                (s -= ft.css(t, "border" + Wt[o] + "Width", !0, r)))
            : ((s += ft.css(t, "padding" + Wt[o], !0, r)),
              "padding" !== i &&
                (s += ft.css(t, "border" + Wt[o] + "Width", !0, r)));
      return s;
    }
    ...
    function V(t, e, i) {
      ...
      for (
        ...
        if ((n = V.prefilters[o].call(u, t, c, u.opts)))
          return (
          ...
          for (
            ...
            if (null != (t = arguments[a]))
              for (e in t)
                (i = s[e]),
                  s !== (n = t[e]) &&
                    (u && n && (ft.isPlainObject(n) || (r = Array.isArray(n)))
                      ? (r
      ...
      ft.extend({
        ...
        isPlainObject: function (t) {
          ...
          return !(
            ...
            ((e = it(t)) &&
              ("function" !=
                typeof (i = ut.call(e, "constructor") && e.constructor) ||
                ct.call(i) !== ht))
          );
        },
    ...
    var _t = (function (t) {
      function e(t, e, i, n) {
        ...
        if (
          !n &&
          ((e ? e.ownerDocument || e : z) !== O && D(e), (e = e || O), Y)
        ) {
          if (11 !== f && (l = gt.exec(t)))
            if ((r = l[1])) {
              if (9 === f) {
        ...
        var r = i.length > 0,
          ...
          s = function (n, s, a, l, u) {
            ...
            for (
              ...
              if (o && c) {
                for (
                  h = 0, s || c.ownerDocument === O || (D(c), (a = !Y));
                  (d = t[h++]);
            ...
            if (((p += f), r && f !== p)) {
              ...
              if (n) {
                if (p > 0) for (; f--; ) m[f] || y[f] || (y[f] = U.call(l));
                y = g(y);
              }
              K.apply(l, y),
                u && !n && y.length > 0 && p + i.length > 1 && e.uniqueSort(l);
            }
            return u && ((W = b), (S = v)), m;
          };
        return r ? n(s) : s;
      ...
      try {
        K.apply((q = X.call(z.childNodes)), z.childNodes),
        ...
        function (t) {
          ...
          return n !== O && 9 === n.nodeType && n.documentElement
            ? ((j = (O = n).documentElement),
              ...
              (b.getElementsByClassName = ft.test(O.getElementsByClassName)),
              (b.getById = r(function (t) {
                return (
                  (j.appendChild(t).id = R),
              ...
              (L = []),
              (k = []),
              (b.qsa = ft.test(O.querySelectorAll)) &&
                (r(function (t) {
              ...
              (b.matchesSelector = ft.test(
                ...
                r(function (t) {
                  (b.disconnectedMatch = N.call(t, "*")),
                    N.call(t, "[s!='']:x"),
                    L.push("!=", nt);
                }),
              (k = k.length && new RegExp(k.join("|"))),
              (L = L.length && new RegExp(L.join("|"))),
              (e = ft.test(j.compareDocumentPosition)),
              (Q =
                e || ft.test(j.contains)
                  ? function (t, e) {
      ...
      return (
          ...
          function (t, e, i, n) {
            ...
            if (((i = i || []), 1 === d.length)) {
              if (
                ...
                if (
                  !(e = (T.find.ID(s.matches[0].replace(yt, vt), e) || [])[0])
                )
                  return i;
        ...
        (b.sortStable = R.split("").sort(V).join("") === R),
    ...
    ((ft.fn.init = function (t, e, i) {
      ...
      if (((i = i || xt), "string" == typeof t)) {
        ...
        return (
          (r = et.getElementById(n[2])) && ((this[0] = r), (this.length = 1)),
          this
        );
      }
      return t.nodeType
      ...
      ft.each(
        ...
        function (t, e) {
          ft.fn[t] = function (i, n) {
            ...
            return (
              "Until" !== t.slice(-5) && (n = i),
              n && "string" == typeof n && (r = ft.filter(n, r)),
              this.length > 1 &&
                (It[t] || ft.uniqueSort(r), St.test(t) && r.reverse()),
              this.pushStack(r)
            );
          };
        }
    ...
    (ft.Callbacks = function (t) {
      ...
      ft.extend({
            ...
            r = {
              ...
              then: function (e, n, r) {
                      ...
                      h = function () {
                        ...
                        if (!(e < s)) {
                          ...
                          (h =
                            ...
                            ft.isFunction(h)
                              ? r
                                ? h.call(t, o(s, i, l, r), o(s, i, u, r))
                                : (s++,
                                  h.call(
                                    t,
                                    o(s, i, l, r),
                                    o(s, i, u, r),
                                    o(s, i, l, i.notifyWith)
                                  ))
                              : (n !== l && ((a = void 0), (c = [t])),
                                (r || i.resolveWith)(a, c));
                        }
                ...
                return ft
                  .Deferred(function (t) {
                    i[0][3].add(
                      o(0, t, ft.isFunction(r) ? r : l, t.notifyWith)
                    ),
                      i[1][3].add(o(0, t, ft.isFunction(e) ? e : l)),
                      i[2][3].add(o(0, t, ft.isFunction(n) ? n : u));
                  })
                  .promise();
              },
              promise: function (t) {
        ...
        when: function (t) {
          ...
          if (
            e <= 1 &&
            (c(t, o.done(s(i)).resolve, o.reject, !e),
            "pending" === o.state() || ft.isFunction(r[i] && r[i].then))
          )
            return o.then();
      ...
      ft.extend({
        ...
        ready: function (t) {
          (!0 === t ? --ft.readyWait : ft.isReady) ||
            ((ft.isReady = !0),
            (!0 !== t && --ft.readyWait > 0) || Ot.resolveWith(et, [ft]));
        },
      }),
    ...
    var jt = function (t, e, i, n, r, o, s) {
        var a = 0,
          ...
          u = null == i;
        if ("object" === ft.type(i))
          for (a in ((r = !0), i)) jt(t, e, a, i[a], !0, o, s);
        else if (
          void 0 !== n &&
          ((r = !0),
          ft.isFunction(n) || (s = !0),
    ...
    (d.uid = 1),
      (d.prototype = {
        ...
        set: function (t, e, i) {
          ...
          else for (n in e) r[ft.camelCase(n)] = e[n];
          return r;
        },
        get: function (t, e) {
          return void 0 === e
          ...
          if (void 0 !== n) {
            if (void 0 !== e) {
              Array.isArray(e)
                ...
                : (e = (e = ft.camelCase(e)) in n ? [e] : e.match(At) || []),
                (i = e.length);
              for (; i--; ) delete n[e[i]];
            }
      ...
      ft.fn.extend({
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((r = Lt.get(o)), 1 === o.nodeType && !kt.get(o, "hasDataAttrs"))
            ) {
              for (i = s.length; i--; )
                s[i] &&
                  0 === (n = s[i].name).indexOf("data-") &&
                  ((n = ft.camelCase(n.slice(5))), f(o, n, r[n]));
        ...
        queue: function (t, e, i) {
          ...
          if (t)
            return (
              ...
              i &&
                (!n || Array.isArray(i)
                  ? (n = kt.access(t, e, ft.makeArray(i)))
                  : n.push(i)),
              n || []
            );
        },
    ...
    (ft.event = {
        ...
        if (m)
          for (
            i.handler && ((i = (o = i).handler), (r = o.selector)),
              r && ft.find.matchesSelector(Gt, r),
      ...
      dispatch: function (t) {
        ...
        if (
          ...
          for (
            s = ft.event.handlers.call(this, a, u), e = 0;
    ...
    ft.extend({
      ...
      clone: function (t, e, i) {
        ...
        if (
          ...
          for (s = v(a), n = 0, r = (o = v(t)).length; n < r; n++)
            A(o[n], s[n]);
        if (e)
          if (i)
            for (o = o || v(t), s = s || v(a), n = 0, r = o.length; n < r; n++)
              I(o[n], s[n]);
          else I(t, a);
      ...
      cleanData: function (t) {
        for (
          var e, i, n, r = ft.event.special, o = 0;
          void 0 !== (i = t[o]);
          o++
        )
          if (Yt(i)) {
      ...
      ft.each(
        ...
        function (t, e) {
          ft.fn[t] = function (t) {
            for (var i, n = [], r = ft(t), o = r.length - 1, s = 0; s <= o; s++)
        ...
        ft.cssHooks[e] = {
          ...
          set: function (t, i, n) {
            var r,
              ...
              s =
                n &&
                Q(t, e, n, "border-box" === ft.css(t, "boxSizing", !1, o), o);
            return (
              s &&
                (r = zt.exec(i)) &&
                "px" !== (r[3] || "px") &&
      ...
      prefilters: [
        function (t, e, i) {
          var n,
            ...
            m = kt.get(t, "fxshow");
          for (n in (i.queue ||
            (null == (s = ft._queueHooks(t, "fx")).unqueued &&
              ((s.unqueued = 0),
              (a = s.empty.fire),
          ...
          if ((l = !ft.isEmptyObject(e)) || !ft.isEmptyObject(p))
            for (n in (h &&
              ...
              null == (u = m && m.display) && (u = kt.get(t, "display")),
            ...
            p))
              l ||
                (m
                  ...
                  : (m = kt.access(t, "fxshow", { display: u })),
                o && (m.hidden = !g),
                g && y([t], !0),
                d.done(function () {
                  for (n in (g || y([t]), kt.remove(t, "fxshow"), p))
                    ft.style(t, n, p[n]);
                })),
                (l = F(g ? m[n] : 0, n, d)),
                n in m ||
        ...
        stop: function (t, e, i) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (r in s) s[r] && s[r].stop && me.test(r) && n(s[r]);
              for (r = o.length; r--; )
                o[r].elem !== this ||
                  (null != t && o[r].queue !== t) ||
      ...
      (function () {
        var t = et.createElement("input"),
          e = et
            ...
            .appendChild(et.createElement("option"));
        (t.type = "checkbox"),
          (dt.checkOn = "" !== t.value),
            ...
            return void 0 === t.getAttribute
              ...
              : ((1 === o && ft.isXMLDoc(t)) ||
                  (r =
                    ...
                    (ft.expr.match.bool.test(e) ? ye : void 0)),
                void 0 !== i
                  ? null === i
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : _e.test(t.nodeName) || (be.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
      ...
      ft.fn.extend({
          ...
          return "boolean" == typeof e && "string" === i
            ...
            : this.each(function () {
                ...
                if ("string" === i)
                  ...
                  (void 0 !== t && "boolean" !== i) ||
                    ((e = q(this)) && kt.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
        ...
        hasClass: function (t) {
          var e,
            ...
            n = 0;
          for (e = " " + t + " "; (i = this[n++]); )
            if (1 === i.nodeType && (" " + $(q(i)) + " ").indexOf(e) > -1)
              return !0;
          return !1;
        },
      });
        ...
        return arguments.length
          ? ((n = ft.isFunction(t)),
            this.each(function (i) {
              var r;
              1 === this.nodeType &&
                (null == (r = n ? t.call(this, i, ft(this).val()) : t)
                  ? (r = "")
                  : "number" == typeof r
                  ? (r += "")
                  : Array.isArray(r) &&
          ...
          : r
          ? (e =
              ft.valHooks[r.type] || ft.valHooks[r.nodeName.toLowerCase()]) &&
            "get" in e &&
      ...
      ft.extend({
        valHooks: {
          ...
          select: {
            get: function (t) {
              ...
              for (n = s < 0 ? u : a ? s : 0; n < u; n++)
                if (
                  ((i = o[n]).selected || n === s) &&
                  !i.disabled &&
                  (!i.parentNode.disabled || !r(i.parentNode, "optgroup"))
                ) {
            ...
            set: function (t, e) {
              for (
                var i, n, r = t.options, o = ft.makeArray(e), s = r.length;
                s--;

              )
                ((n = r[s]).selected =
                  ft.inArray(ft.valHooks.option.get(n), o) > -1) && (i = !0);
      ...
      trigger: function (e, i, n, r) {
        ...
        if (
          ...
          3 !== n.nodeType &&
            ...
            ((e = e[ft.expando]
              ? e
              : new ft.Event(p, "object" == typeof e && e)).isTrigger = r
              ? 2
              : 3),
            (e.namespace = f.join(".")),
          ...
          if (!r && !h.noBubble && !ft.isWindow(n)) {
            for (
              l = h.delegateType || p, we.test(l + p) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              d.push(s), (a = s);
          ...
          for (o = 0; (s = d[o++]) && !e.isPropagationStopped(); )
            (e.type = o > 1 ? l : h.bindType || p),
              (c =
                (kt.get(s, "events") || {})[e.type] && kt.get(s, "handle")) &&
                c.apply(s, i),
              (c = u && s[u]) &&
                c.apply &&
                Yt(s) &&
    ...
    (We.href = Ce.href),
        ...
        ajax: function (e, i) {
          function n(e, i, n, a) {
            ...
            c ||
              ...
              u
                ? (f.ifModified &&
                    ((T = C.getResponseHeader("Last-Modified")) &&
                      (ft.lastModified[o] = T),
                    (T = C.getResponseHeader("etag")) && (ft.etag[o] = T)),
                  204 === e || "HEAD" === f.type
                    ? (w = "nocontent")
                    : 304 === e
                    ? (w = "notmodified")
              ...
              (C.status = e),
              (C.statusText = (i || w) + ""),
              u ? y.resolveWith(g, [d, w, C]) : y.rejectWith(g, [C, w, p]),
              C.statusCode(_),
              (_ = void 0),
              h &&
                m.trigger(u ? "ajaxSuccess" : "ajaxError", [C, f, u ? d : p]),
              v.fireWith(g, [C, w]),
              h &&
          ...
          if (
            ...
            try {
              (u.href = f.url),
                (u.href = u.href),
                (f.crossDomain =
                  We.protocol + "//" + We.host != u.protocol + "//" + u.host);
            } catch (t) {
              f.crossDomain = !0;
            }
          }
          ...
          f.hasContent
            ...
            : ((p = f.url.slice(o.length)),
              f.data &&
                ((o += (xe.test(o) ? "&" : "?") + f.data), delete f.data),
              !1 === f.cache &&
                ((o = o.replace(je, "$1")),
                (p = (xe.test(o) ? "&" : "?") + "_=" + Ee++ + p)),
              (f.url = o + p)),
          ...
          if (
            ...
            if (((C.readyState = 1), h && m.trigger("ajaxSend", [C, f]), c))
              return C;
            f.async &&
              f.timeout > 0 &&
      ...
      ft.each(["get", "post"], function (t, e) {
        ft[e] = function (t, i, n, r) {
          return (
            ft.isFunction(i) && ((r = r || n), (n = i), (i = void 0)),
            ft.ajax(
              ft.extend(
    ...
    (dt.cors = !!He && "withCredentials" in He),
      (dt.ajax = He = !!He),
      ft.ajaxTransport(function (e) {
        var i, n;
        if (dt.cors || (He && !e.crossDomain))
          return {
            send: function (r, o) {
              var s,
                a = e.xhr();
    ...
    ft.ajaxSetup({
          ...
          return (
            ...
            n.always(function () {
              void 0 === o ? ft(t).removeProp(r) : (t[r] = o),
                e[r] && ((e.jsonpCallback = i.jsonpCallback), Fe.push(r)),
        ...
        return (
          ...
          s.length > 0 &&
            ft
              ...
              .done(function (t) {
                (o = arguments),
                  s.html(n ? ft("<div>").append(ft.parseHTML(t)).find(n) : t);
              })
              .always(
                i &&
                  function (t, e) {
          ...
          return o
            ? o.getClientRects().length
              ? ((n = o.getBoundingClientRect()),
                (i = (e = o.ownerDocument).documentElement),
                (r = e.defaultView),
                {
      ...
      ft.each(["top", "left"], function (t, e) {
        ft.cssHooks[e] = Y(dt.pixelPosition, function (t, i) {
          if (i)
            return (i = j(t, e)), oe.test(i) ? ft(t).position()[e] + "px" : i;
        });
      }),
    ...
    return (
      (ft.noConflict = function (e) {
        return (
          t.$ === ft && (t.$ = $e), e && t.jQuery === ft && (t.jQuery = Ve), ft
        );
      }),
      e || (t.jQuery = t.$ = ft),
      ft
  ...
  (function (t, e) {
    ...
    var L = E.Utils,
      ...
      l = ((a = L.getBounds), L.getOffsetParent),
      d = ((c = L.extend), L.addClass),
      h = L.removeClass,
      u =
        ((m = L.updateClasses),
        (D = L.defer),
                ...
                ["left", "top", "bottom", "right", "middle", "center"].forEach(
                  ...
                  D(function () {
                    void 0 !== i._addAttachClasses &&
                      (m(i.element, i._addAttachClasses, o),
                      !1 !== i.options.addTargetClasses &&
                        m(i.target, i._addAttachClasses, o),
              ...
              value: function () {
                ...
                if (this.enabled) {
                  ...
                  var c = this.cache("target-bounds", function () {
                    ...
                    h = c,
                    d = T(F(this.attachment), { width: r, height: o }),
                    p = T(F(i), h),
                    f = T(this.offset, { width: r, height: o }),
                  ...
                  return (
                    C.body.scrollWidth > x.innerWidth &&
                      ...
                      (w.viewport.bottom -= P.height)),
                    C.body.scrollHeight > x.innerHeight &&
                      ((P = this.cache("scrollbar-size", u)),
                      (w.viewport.right -= P.width)),
                    (-1 === ["", "static"].indexOf(C.body.style.position) ||
                      -1 ===
                        ["", "static"].indexOf(
                          C.body.parentElement.style.position
                        )) &&
                      ((w.page.bottom = C.body.scrollHeight - y - o),
                      (w.page.right = C.body.scrollWidth - m - r)),
                ...
                if (void 0 !== this.element.parentNode) {
                      ...
                      if (
                        ...
                        t.top
                          ...
                          (u[N] =
                            ...
                            Math.round(n) +
                            "px)"),
                          "msTransform" !== N && (u[N] += " translateZ(0)");
                      } else
                        t.top
                          ? (u.top = i.top + "px")
                  ...
                  if (
                    ...
                    (i.page.left || i.page.right)
                      ? ((u.position = "absolute"), h(i.page, t.page))
                      : (i.viewport.top || i.viewport.bottom) &&
                        (i.viewport.left || i.viewport.right)
                      ? ((u.position = "fixed"), h(i.viewport, t.viewport))
      ...
      position: function (t) {
        ...
        return (
          this.options.constraints.forEach(function (t) {
            ...
            var _ = w(e, o);
            ("target" === h || "both" === h) &&
              (i < _[1] && "top" === y.top && ((i += d), (y.top = "bottom")),
              i + s > _[3] &&
                "bottom" === y.top &&
                ((i -= d), (y.top = "top"))),
              "together" === h &&
                ("top" === y.top &&
                  ("bottom" === v.top && i < _[1]
                    ? ((i += d), (y.top = "bottom"), (i += s), (v.top = "top"))
                    : "top" === v.top &&
                      i + s > _[3] &&
                      i - (s - d) >= _[1] &&
                      ((i -= s - d), (y.top = "bottom"), (v.top = "bottom"))),
                "bottom" === y.top &&
                  ("top" === v.top && i + s > _[3]
                    ? ((i -= d), (y.top = "top"), (i -= s), (v.top = "bottom"))
                    : "bottom" === v.top &&
                      i < _[1] &&
                      i + (2 * s - d) <= _[3] &&
                      ((i += s - d), (y.top = "top"), (v.top = "top"))),
                "middle" === y.top &&
                  (i + s > _[3] && "top" === v.top
                    ? ((i -= s), (v.top = "bottom"))
                    : i < _[1] &&
                ...
                (n < _[0] && "left" === y.left
                  ...
                  ? "left" === v.left
                    ? ((n -= p),
                      ...
                      (v.left = "right"))
                    : "right" === v.left &&
                      ((n -= p), (y.left = "left"), (n += l), (v.left = "left"))
                  : "center" === y.left &&
                    (n + l > _[2] && "left" === v.left
                      ? ((n -= l), (v.left = "right"))
                      : n < _[0] &&
                        ...
                        ((n += l), (v.left = "left")))),
              ("element" === h || "both" === h) &&
                (i < _[1] && "bottom" === v.top && ((i += s), (v.top = "top")),
                i + s > _[3] &&
                  "top" === v.top &&
                  ((i -= s), (v.top = "bottom"))),
              ("element" === c || "both" === c) &&
                (n < _[0] &&
                  ("right" === v.left
                    ? ((n += l), (v.left = "left"))
                    : "center" === v.left && ((n += l / 2), (v.left = "left"))),
                n + l > _[2] &&
                  ("left" === v.left
                    ? ((n -= l), (v.left = "right"))
                    : "center" === v.left &&
            ...
            i < _[1] &&
              ...
              (y.top !== r.top ||
                ...
                (e.updateAttachClasses(v, y),
                e.trigger("update", { attachment: v, targetAttachment: y }));
          }),
          D(function () {
      ...
      E.modules.push({
        position: function (t) {
          ...
          return (
            ...
            h.length && p.push(this.getClass("abutted")),
...
!(function (t) {
  ...
  (function () {
    ...
    var n =
      ...
      o = (function (t) {
        ...
        return (
          ...
          (t.fn.emulateTransitionEnd = function o(e) {
            var i = this,
              n = !1;
            return (
          ...
          l.supportsTransitionEnd() &&
            (t.event.special[l.TRANSITION_END] = (function n() {
              return {
                bindType: s.end,
                delegateType: s.end,
                handle: function (e) {
      ...
      s =
            ...
            h = (function () {
              ...
              return (
                ...
                (e.prototype._removeElement = function (e) {
                  var i = this;
                  return (
                    t(e).removeClass(c_SHOW),
                    o.supportsTransitionEnd() && t(e).hasClass(c_FADE)
                      ? void t(e)
        ...
        (function (t) {
          var e = "button",
            ...
            l_BUTTON = "btn",
            l_FOCUS = "focus",
            u_DATA_TOGGLE_CARROT = '[data-toggle^="button"]',
            u_DATA_TOGGLE = '[data-toggle="buttons"]',
            u_INPUT = "input",
            u_ACTIVE = ".active",
            u_BUTTON = ".btn",
            c = {
            ...
            h = (function () {
              ...
              return (
                (e.prototype.toggle = function () {
                  var e = !0,
                    i = t(this._element).closest(u_DATA_TOGGLE)[0];
                  if (i) {
                    var n = t(this._element).find(u_INPUT)[0];
                    if (n) {
                      if ("radio" === n.type)
                        if (n.checked && t(this._element).hasClass(l_ACTIVE))
                          e = !1;
                        else {
                          var r = t(i).find(u_ACTIVE)[0];
                          r && t(r).removeClass(l_ACTIVE);
                        }
                      e &&
                        ((n.checked = !t(this._element).hasClass(l_ACTIVE)),
                        t(n).trigger("change")),
                        n.focus();
                    }
                  }
                  this._element.setAttribute(
                    "aria-pressed",
                    !t(this._element).hasClass(l_ACTIVE)
                  ),
                    e && t(this._element).toggleClass(l_ACTIVE);
                }),
                (e.prototype.dispose = function () {
                  t.removeData(this._element, n), (this._element = null);
                }),
          ...
          t(document)
            .on(c.CLICK_DATA_API, u_DATA_TOGGLE_CARROT, function (e) {
              e.preventDefault();
              var i = e.target;
              t(i).hasClass(l_BUTTON) || (i = t(i).closest(u_BUTTON)),
                h._jQueryInterface.call(t(i), "toggle");
            })
            .on(c.FOCUS_BLUR_DATA_API, u_DATA_TOGGLE_CARROT, function (e) {
              var i = t(e.target).closest(u_BUTTON)[0];
              t(i).toggleClass(l_FOCUS, /^focus(in)?$/.test(e.type));
            }),
            (t.fn[e] = h._jQueryInterface),
            (t.fn[e].Constructor = h),
            (t.fn[e].noConflict = function () {
        ...
        (function (t) {
          var e = "carousel",
            ...
            f_ACTIVE = "active",
            f_SLIDE = "slide",
            f_RIGHT = "carousel-item-right",
            f_LEFT = "carousel-item-left",
            f_NEXT = "carousel-item-next",
            f_PREV = "carousel-item-prev",
            g_ACTIVE = ".active",
            g_ACTIVE_ITEM = ".active.carousel-item",
            g_ITEM = ".carousel-item",
            g_NEXT_PREV = ".carousel-item-next, .carousel-item-prev",
            g_INDICATORS = ".carousel-indicators",
            g_DATA_SLIDE = "[data-slide], [data-slide-to]",
            g_DATA_RIDE = '[data-ride="carousel"]',
            m = (function () {
              function l(e, n) {
                i(this, l),
                  (this._items = null),
              ...
              return (
                ...
                (l.prototype.pause = function (e) {
                  e || (this._isPaused = !0),
                    t(this._element).find(g_NEXT_PREV)[0] &&
                ...
                (l.prototype.to = function (e) {
                  var i = this;
                  this._activeElement = t(this._element).find(g_ACTIVE_ITEM)[0];
                ...
                (l.prototype._getConfig = function (i) {
                  return (
                    (i = t.extend({}, c, i)), o.typeCheckConfig(e, i, h), i
                  );
                }),
                ...
                (l.prototype._getItemIndex = function (e) {
                  return (
                    (this._items = t.makeArray(t(e).parent().find(g_ITEM))),
                ...
                (l.prototype._getItemByDirection = function (t, e) {
                  ...
                  if (((n && 0 === r) || (i && r === o)) && !this._config.wrap)
                    return e;
                  var s =
                    (r + (t === d.PREVIOUS ? -1 : 1)) % this._items.length;
                  return -1 === s
                ...
                (l.prototype._setActiveIndicatorElement = function (e) {
                  if (this._indicatorsElement) {
                    ...
                    i && t(i).addClass(f_ACTIVE);
                  }
                }),
                (l.prototype._slide = function (e, i) {
                  var n = this,
                    r = t(this._element).find(g_ACTIVE_ITEM)[0],
                  ...
                  if (
                    (e === d.NEXT
                      ? ((l = f_LEFT), (u = f_NEXT), (c = d.LEFT))
                      : ((l = f_RIGHT), (u = f_PREV), (c = d.RIGHT)),
                    s && t(s).hasClass(f_ACTIVE))
                  )
                    this._isSliding = !1;
                  else if (
                    ...
                    var h = t.Event(p.SLID, { relatedTarget: s, direction: c });
                    o.supportsTransitionEnd() &&
                    t(this._element).hasClass(f_SLIDE)
                      ? (t(s).addClass(u),
                        o.reflow(s),
                        t(r).addClass(l),
                        t(s).addClass(l),
                      ...
                      : (t(r).removeClass(f_ACTIVE),
                        t(s).addClass(f_ACTIVE),
                        (this._isSliding = !1),
                ...
                (l._jQueryInterface = function (e) {
                  return this.each(function () {
                    ...
                    if (
                      (i || ((i = new l(this, r)), t(this).data(s, i)),
                      "number" == typeof e)
                    )
                      i.to(e);
        ...
        (function (t) {
          var e = "collapse",
            ...
            d_SHOW = "show",
            d_COLLAPSE = "collapse",
            d_COLLAPSING = "collapsing",
            d_COLLAPSED = "collapsed",
            p_WIDTH = "width",
            p_HEIGHT = "height",
            f_ACTIVES = ".card > .show, .card > .collapsing",
            f_DATA_TOGGLE = '[data-toggle="collapse"]',
            g = (function () {
              function a(e, n) {
                i(this, a),
              ...
              return (
                (a.prototype.toggle = function () {
                  t(this._element).hasClass(d_SHOW) ? this.hide() : this.show();
                }),
                (a.prototype.show = function () {
                  var e = this;
                  if (this._isTransitioning)
                    throw new Error("Collapse is transitioning");
                  if (!t(this._element).hasClass(d_SHOW)) {
                    var i = void 0,
                      n = void 0;
                    if (
                      (this._parent &&
                        ((i = t.makeArray(t(this._parent).find(f_ACTIVES)))
                          .length ||
                          (i = null)),
                      ...
                      if (
                        ...
                        t(this._element)
                          .removeClass(d_COLLAPSE)
                          .addClass(d_COLLAPSING),
                          (this._element.style[l] = 0),
                          this._element.setAttribute("aria-expanded", !0),
                          this._triggerArray.length &&
                            t(this._triggerArray)
                              .removeClass(d_COLLAPSED)
                              .attr("aria-expanded", !0),
                          this.setTransitioning(!0);
                        var u = function () {
                          t(e._element)
                            .removeClass(d_COLLAPSING)
                            .addClass(d_COLLAPSE)
                            .addClass(d_SHOW),
                            (e._element.style[l] = ""),
                  ...
                  if (t(this._element).hasClass(d_SHOW)) {
                    ...
                    if (
                      ...
                      var n = this._getDimension(),
                        r = n === p_WIDTH ? "offsetWidth" : "offsetHeight";
                ...
                (a.prototype._getConfig = function (i) {
                  return (
                    ((i = t.extend({}, u, i)).toggle = Boolean(i.toggle)),
                    o.typeCheckConfig(e, i, c),
                    i
                  );
                }),
                (a.prototype._getDimension = function () {
                  return t(this._element).hasClass(p_WIDTH)
                    ? p_WIDTH
                    : p_HEIGHT;
                }),
                ...
                (a.prototype._addAriaAndCollapsedClass = function (e, i) {
                  if (e) {
                    var n = t(e).hasClass(d_SHOW);
                    e.setAttribute("aria-expanded", n),
                      i.length &&
                        t(i)
                          .toggleClass(d_COLLAPSED, !n)
          ...
          t(document).on(h.CLICK_DATA_API, f_DATA_TOGGLE, function (e) {
            e.preventDefault();
        ...
        (function (t) {
          var e = "dropdown",
            ...
            c_BACKDROP = "dropdown-backdrop",
            c_DISABLED = "disabled",
            c_SHOW = "show",
            h_BACKDROP = ".dropdown-backdrop",
            h_DATA_TOGGLE = '[data-toggle="dropdown"]',
            h_FORM_CHILD = ".dropdown form",
            h_ROLE_MENU = '[role="menu"]',
            h_ROLE_LISTBOX = '[role="listbox"]',
            h_NAVBAR_NAV = ".navbar-nav",
            h_VISIBLE_ITEMS =
            ...
            d = (function () {
              ...
              return (
                (e.prototype.toggle = function () {
                  if (this.disabled || t(this).hasClass(c_DISABLED)) return !1;
                  var i = e._getParentFromElement(this),
                    n = t(i).hasClass(c_SHOW);
                  if ((e._clearMenus(), n)) return !1;
                  if (
                    "ontouchstart" in document.documentElement &&
                    !t(i).closest(h_NAVBAR_NAV).length
                  ) {
                    var r = document.createElement("div");
                    (r.className = c_BACKDROP),
                  ...
                  return (
                    ...
                    !s.isDefaultPrevented() &&
                      ...
                      t(i).toggleClass(c_SHOW),
                      t(i).trigger(t.Event(u.SHOWN, o)),
                      !1)
                  );
                }),
                (e.prototype.dispose = function () {
                ...
                (e._clearMenus = function (i) {
                  if (!i || 3 !== i.which) {
                    var n = t(h_BACKDROP)[0];
                    n && n.parentNode.removeChild(n);
                    for (
                      var r = t.makeArray(t(h_DATA_TOGGLE)), o = 0;
                      o < r.length;
                      o++
                    ) {
                ...
                (e._dataApiKeydownHandler = function (i) {
                  if (
                    ...
                    (i.preventDefault(),
                    i.stopPropagation(),
                    !this.disabled && !t(this).hasClass(c_DISABLED))
                  ) {
                    var n = e._getParentFromElement(this),
                      r = t(n).hasClass(c_SHOW);
                    if ((!r && 27 !== i.which) || (r && 27 === i.which)) {
                      if (27 === i.which) {
                        var o = t(n).find(h_DATA_TOGGLE)[0];
                        t(o).trigger("focus");
                      }
                      return void t(this).trigger("click");
                    }
                    var s = t(n).find(h_VISIBLE_ITEMS).get();
                    if (s.length) {
          ...
          t(document)
            .on(u.KEYDOWN_DATA_API, h_DATA_TOGGLE, d._dataApiKeydownHandler)
            .on(u.KEYDOWN_DATA_API, h_ROLE_MENU, d._dataApiKeydownHandler)
            .on(u.KEYDOWN_DATA_API, h_ROLE_LISTBOX, d._dataApiKeydownHandler)
            .on(u.CLICK_DATA_API + " " + u.FOCUSIN_DATA_API, d._clearMenus)
            .on(u.CLICK_DATA_API, h_DATA_TOGGLE, d.prototype.toggle)
            .on(u.CLICK_DATA_API, h_FORM_CHILD, function (t) {
              t.stopPropagation();
            }),
        ...
        (function (t) {
          var e = "modal",
            ...
            d_SCROLLBAR_MEASURER = "modal-scrollbar-measure",
            d_BACKDROP = "modal-backdrop",
            d_OPEN = "modal-open",
            d_FADE = "fade",
            d_SHOW = "show",
            p_DIALOG = ".modal-dialog",
            p_DATA_TOGGLE = '[data-toggle="modal"]',
            p_DATA_DISMISS = '[data-dismiss="modal"]',
            p_FIXED_CONTENT =
            ...
            f = (function () {
              function l(e, n) {
                i(this, l),
                  (this._config = this._getConfig(n)),
                  (this._element = e),
                  (this._dialog = t(e).find(p_DIALOG)[0]),
                  (this._backdrop = null),
                  (this._isShown = !1),
              ...
              return (
                ...
                (l.prototype.show = function (e) {
                  ...
                  o.supportsTransitionEnd() &&
                    t(this._element).hasClass(d_FADE) &&
                  ...
                  t(this._element).trigger(n),
                    this._isShown ||
                      ...
                      this._setScrollbar(),
                      t(document.body).addClass(d_OPEN),
                ...
                (l.prototype.hide = function (e) {
                  ...
                  t(this._element).trigger(r),
                    this._isShown &&
                      ...
                      t(this._element).removeClass(d_SHOW),
                ...
                (l.prototype._getConfig = function (i) {
                  return (
                    (i = t.extend({}, u, i)), o.typeCheckConfig(e, i, c), i
                  );
                }),
                (l.prototype._showElement = function (e) {
                  ...
                  (this._element.parentNode &&
                    ...
                    t(this._element).addClass(d_SHOW),
                ...
                (l.prototype._hideModal = function () {
                  ...
                  (this._element.style.display = "none"),
                    ...
                    (this._isTransitioning = !1),
                    this._showBackdrop(function () {
                      t(document.body).removeClass(d_OPEN),
                        e._resetAdjustments(),
                        e._resetScrollbar(),
                ...
                (l.prototype._showBackdrop = function (e) {
                  var i = this,
                    n = t(this._element).hasClass(d_FADE) ? d_FADE : "";
                  if (this._isShown && this._config.backdrop) {
                    var r = o.supportsTransitionEnd() && n;
                    if (
                      ((this._backdrop = document.createElement("div")),
                      (this._backdrop.className = d_BACKDROP),
                      ...
                      t(this._backdrop).addClass(d_SHOW),
                      !e)
                    )
                      return;
                    if (!r) return void e();
                    ...
                    t(this._backdrop).removeClass(d_SHOW);
                    var s = function () {
                ...
                (l.prototype._setScrollbar = function () {
                  var e = parseInt(
                    t(p_FIXED_CONTENT).css("padding-right") || 0,
                    10
                  );
                ...
                (l.prototype._getScrollbarWidth = function () {
                  var t = document.createElement("div");
                  (t.className = d_SCROLLBAR_MEASURER),
                    document.body.appendChild(t);
        ...
        (function (t) {
          var e = "scrollspy",
            ...
            d_DROPDOWN_ITEM = "dropdown-item",
            d_ACTIVE = "active",
            p_DATA_SPY = '[data-spy="scroll"]',
            p_ACTIVE = ".active",
            p_LI = "li",
            p_NAV_LINKS = ".nav-link",
            p_DROPDOWN = ".dropdown",
            p_DROPDOWN_ITEMS = ".dropdown-item",
            p_DROPDOWN_TOGGLE = ".dropdown-toggle",
            f_OFFSET = "offset",
            f_POSITION = "position",
            g = (function () {
              function l(e, n) {
              ...
              return (
                (l.prototype.refresh = function () {
                  var e = this,
                    ...
                    r = n === f_POSITION ? this._getScrollTop() : 0;
                  (this._offsets = []),
                    (this._targets = []),
                ...
                (l.prototype._activate = function (e) {
                  ...
                  var n = t(i.join(","));
                  n.hasClass(d_DROPDOWN_ITEM)
                    ? (n
                        .closest(p_DROPDOWN)
                        .find(p_DROPDOWN_TOGGLE)
                        .addClass(d_ACTIVE),
                      n.addClass(d_ACTIVE))
                    : n
                        .parents(p_LI)
                ...
                (l.prototype._clear = function () {
                  t(this._selector).filter(p_ACTIVE).removeClass(d_ACTIVE);
                }),
                (l._jQueryInterface = function (e) {
                  return this.each(function () {
                    var i = t(this).data(s),
          ...
          t(window).on(h.LOAD_DATA_API, function () {
            for (var e = t.makeArray(t(p_DATA_SPY)), i = e.length; i--; ) {
              var n = t(e[i]);
        ...
        (function (t) {
          var e = "tab",
            ...
            c_FADE_CHILD = "> .nav-item .fade, > .fade",
            c_ACTIVE = ".active",
            c_ACTIVE_CHILD = "> .nav-item > .active, > .active",
            c_DATA_TOGGLE = '[data-toggle="tab"], [data-toggle="pill"]',
            c_DROPDOWN_TOGGLE = ".dropdown-toggle",
            c_DROPDOWN_ACTIVE_CHILD = "> .dropdown-menu .active",
            h = (function () {
              function e(t) {
                i(this, e), (this._element = t);
              }
              return (
                    ...
                    !(
                      (this._element.parentNode &&
                        this._element.parentNode.nodeType ===
                          Node.ELEMENT_NODE &&
                        t(this._element).hasClass(u_ACTIVE)) ||
                      t(this._element).hasClass(u_DISABLED)
                    )
                  ) {
                    var i = void 0,
                      n = void 0,
                      r = t(this._element).closest(c_LIST)[0],
                      s = o.getSelectorFromElement(this._element);
                    r &&
                      (n = (n = t.makeArray(t(r).find(c_ACTIVE)))[
                        n.length - 1
                      ]);
                    var a = t.Event(l.HIDE, { relatedTarget: this._element }),
                      h = t.Event(l.SHOW, { relatedTarget: n });
                    if (
                      (n && t(n).trigger(a),
                      t(this._element).trigger(h),
                      ...
                      var d = function () {
                        var i = t.Event(l.HIDDEN, {
                          ...
                          r = t.Event(l.SHOWN, { relatedTarget: n });
                ...
                (e.prototype._activate = function (e, i, n) {
                  var r = this,
                    s = t(i).find(c_ACTIVE_CHILD)[0],
                    a =
                      n &&
                      o.supportsTransitionEnd() &&
                      ((s && t(s).hasClass(u_FADE)) ||
                        Boolean(t(i).find(c_FADE_CHILD)[0])),
                    l = function () {
                      return r._transitionComplete(e, s, a, n);
                    };
                  s && a
                    ? t(s).one(o.TRANSITION_END, l).emulateTransitionEnd(150)
                    : l(),
                    s && t(s).removeClass(u_SHOW);
                }),
                (e.prototype._transitionComplete = function (e, i, n, r) {
                  if (i) {
                    t(i).removeClass(u_ACTIVE);
                    var s = t(i.parentNode).find(c_DROPDOWN_ACTIVE_CHILD)[0];
                    s && t(s).removeClass(u_ACTIVE),
                      i.setAttribute("aria-expanded", !1);
                  }
                  if (
                    (t(e).addClass(u_ACTIVE),
                    e.setAttribute("aria-expanded", !0),
                    n
                      ? (o.reflow(e), t(e).addClass(u_SHOW))
                      : t(e).removeClass(u_FADE),
                    e.parentNode && t(e.parentNode).hasClass(u_DROPDOWN_MENU))
                  ) {
                    var a = t(e).closest(c_DROPDOWN)[0];
                    a && t(a).find(c_DROPDOWN_TOGGLE).addClass(u_ACTIVE),
                      e.setAttribute("aria-expanded", !0);
                  }
                  r && r();
                }),
          ...
          t(document).on(l.CLICK_DATA_API, c_DATA_TOGGLE, function (e) {
              ...
              return (
                ...
                (l.prototype.toggle = function (e) {
                  if (e) {
                    ...
                    if (t(this.getTipElement()).hasClass(f_SHOW))
                ...
                (l.prototype.show = function () {
                  ...
                  if (this.isWithContent() && this._isEnabled) {
                    ...
                    r.setAttribute("id", s),
                      ...
                      this.setContent(),
                      this.config.animation && t(r).addClass(f_FADE);
                    var a =
                    ...
                    t(r).data(this.constructor.DATA_KEY, this).appendTo(c),
                    ...
                    var h = function () {
                      ...
                      (e._hoverState = null),
                        ...
                        i === d_OUT && e._leave(null, e);
                    };
                    if (
                      o.supportsTransitionEnd() &&
                      t(this.tip).hasClass(f_FADE)
                    )
                      return (
                        (this._isTransitioning = !0),
                        void t(this.tip)
                ...
                (l.prototype.hide = function (e) {
                  ...
                  t(this.element).trigger(r),
                    r.isDefaultPrevented() ||
                      (t(n).removeClass(f_SHOW),
                      (this._activeTrigger[y_CLICK] = !1),
                      (this._activeTrigger[y_FOCUS] = !1),
                      (this._activeTrigger[y_HOVER] = !1),
                      o.supportsTransitionEnd() && t(this.tip).hasClass(f_FADE)
                        ? ((this._isTransitioning = !0),
                          t(n)
                            .one(o.TRANSITION_END, s)
                            .emulateTransitionEnd(150))
                ...
                (l.prototype.setContent = function () {
                  ...
                  this.setElementContent(
                    e.find(g_TOOLTIP_INNER),
                    this.getTitle()
                  ),
                    e.removeClass(f_FADE + " " + f_SHOW),
                    this.cleanupTether();
                }),
                ...
                (l.prototype._enter = function (e, i) {
                  ...
                  return (
                    ...
                    e &&
                      (i._activeTrigger[
                        "focusin" === e.type ? y_FOCUS : y_HOVER
                      ] = !0),
                    t(i.getTipElement()).hasClass(f_SHOW) ||
                    i._hoverState === d_SHOW
                      ? void (i._hoverState = d_SHOW)
                      : (clearTimeout(i._timeout),
                        (i._hoverState = d_SHOW),
                        i.config.delay && i.config.delay.show
                          ? void (i._timeout = setTimeout(function () {
                              i._hoverState === d_SHOW && i.show();
                            }, i.config.delay.show))
                          : void i.show())
                  );
                }),
                (l.prototype._leave = function (e, i) {
                  ...
                  if (
                    ...
                    e &&
                      (i._activeTrigger[
                        "focusout" === e.type ? y_FOCUS : y_HOVER
                      ] = !1),
    ...
    !(function (o) {
      var a = "popover",
        ...
        p_FADE = "fade",
        p_SHOW = "show",
        f_TITLE = ".popover-title",
        f_CONTENT = ".popover-content",
        g = {
          HIDE: "hide" + u,
          HIDDEN: "hidden" + u,
          SHOW: "show" + u,
        ...
        m = (function (s) {
          ...
          return (
            ...
            (c.prototype.setContent = function () {
              ...
              this.setElementContent(t.find(f_TITLE), this.getTitle()),
                this.setElementContent(t.find(f_CONTENT), this._getContent()),
                t.removeClass(p_FADE + " " + p_SHOW),
                this.cleanupTether();
            }),
            ...
            (c._jQueryInterface = function (t) {
              return this.each(function () {
                ...
                if (
                  ...
                  (e || ((e = new c(this, i)), o(this).data(l, e)),
                  "string" == typeof t)
                ) {
                  if (void 0 === e[t])
        ...
        return e === n
          ...
          : (this.settings.center
              ? (this.settings.rtl && ((r = -1), (o = e + 1)),
                ...
                (i +=
                  ((this.width() - i + (this._coordinates[o] || 0)) / 2) * r))
  ...
  (function (t, e, i, n) {
    ...
    var s = t("<support>").get(0).style,
      ...
      u_csstransforms = function () {
        return !!r("transform");
      },
      u_csstransforms3d = function () {
        return !!r("perspective");
      },
      u_cssanimations = function () {
        return !!r("animation");
      };
    (function () {
      return !!r("transition");
      ...
      u_csstransforms() &&
        ...
        (t.support.transform3d = u_csstransforms3d()));
  })(window.Zepto || window.jQuery, window, document),
  (function (t, e) {
    "use strict";
    "function" == typeof define && define.amd
  ...
  (function (t, e) {
    ...
    function r(r) {
      if (
        ...
        for (
          var c = (u.isBorderBox = "border-box" == s.boxSizing), h = 0;
          l > h;
          h++
        ) {
          var d = a[h],
        ...
        var C = t(s.height);
        return (
          !1 !== C && (u.height = C + (T ? 0 : m + b)),
          (u.innerWidth = u.width - (g + _)),
          (u.innerHeight = u.height - (m + b)),
...
!(function (jQuery, ytp) {
    ...
    (jQuery.fn.CSSAnimate = function (t, e, i, n, r) {
      ...
      return (
        ...
        this.each(function () {
          ...
          var u = u || { type: "noEvent" };
          if (a.CSSAIsRunning && a.eventType == u.type)
            a.CSSqueue = function () {
              l.CSSAnimate(t, e, i, n, r);
            };
          else if (
            ((a.CSSqueue = null), (a.eventType = u.type), 0 !== l.length && t)
          ) {
            if (
              ((a.CSSAIsRunning = !0),
              "function" == typeof e &&
                ((r = e), (e = jQuery.fx.speeds._default)),
              "function" == typeof i && ((r = i), (i = 0)),
              "function" == typeof n &&
                ((r = n), (n = "cubic-bezier(0.65,0.03,0.36,0.72)")),
              "string" == typeof e)
            )
            ...
            if (
              ...
              var h = "",
                d = "transitionEnd";
              for (p in (jQuery.browser.webkit
                ? ((h = "-webkit-"), (d = "webkitTransitionEnd"))
                : jQuery.browser.mozilla
                ? ((h = "-moz-"), (d = "transitionend"))
                : jQuery.browser.opera
                ? ((h = "-o-"), (d = "otransitionend"))
                : jQuery.browser.msie &&
                  ((h = "-ms-"), (d = "msTransitionEnd")),
              (u = []),
              t))
                "transform" === (c = p) &&
                  ((t[(c = h + "transform")] = t[p]), delete t[p]),
                  "filter" === c &&
                    ((t[(c = h + "filter")] = t[p]), delete t[p]),
                  ("transform-origin" === c || "origin" === c) &&
                    ((t[(c = h + "transform-origin")] = t[p]), delete t[p]),
                  "x" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " translateX(" + s(t[p], "px") + ")"),
                    delete t[p]),
                  "y" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " translateY(" + s(t[p], "px") + ")"),
                    delete t[p]),
                  "z" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " translateZ(" + s(t[p], "px") + ")"),
                    delete t[p]),
                  "rotate" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " rotate(" + s(t[p], "deg") + ")"),
                    delete t[p]),
                  "rotateX" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " rotateX(" + s(t[p], "deg") + ")"),
                    delete t[p]),
                  "rotateY" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " rotateY(" + s(t[p], "deg") + ")"),
                    delete t[p]),
                  "rotateZ" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " rotateZ(" + s(t[p], "deg") + ")"),
                    delete t[p]),
                  "scale" === c &&
                    ((t[(c = h + "transform")] = t[c] || ""),
                    (t[c] += " scale(" + s(t[p], "") + ")"),
              ...
              var p = u.join(","),
                f = function () {
                  l.off(d + "." + a.id),
                    ...
                    (a.called = !0),
                    (a.CSSAIsRunning = !1),
                    "function" == typeof a.CSSqueue &&
                      (a.CSSqueue(), (a.CSSqueue = null));
                },
                g = {};
              jQuery.extend(g, t),
                (g[h + "transition-property"] = p),
                (g[h + "transition-duration"] = e + "ms"),
                (g[h + "transition-delay"] = i + "ms"),
                (g[h + "transition-style"] = "preserve-3d"),
                (g[h + "transition-timing-function"] = n),
                setTimeout(function () {
                  l.one(d + "." + a.id, f), l.css(g);
                }, 1),
                (a.timeout = setTimeout(function () {
                  l.called || !r
                    ? ((l.called = !1), (a.CSSAIsRunning = !1))
                    : (l.css(h + "transition", ""),
                      r(l),
                      (a.CSSAIsRunning = !1),
                      "function" == typeof a.CSSqueue &&
  ...
  var getYTPVideoID = function (t) {
    var e, i;
    return (
      t.indexOf("youtu.be") > 0
        ? ((i =
            (e = t.substr(t.lastIndexOf("/") + 1, t.length)).indexOf("?list=") >
            0
              ? e.substr(e.lastIndexOf("="), e.length)
              : null),
          (e = i ? e.substr(0, e.lastIndexOf("?")) : e))
        : t.indexOf("http") > -1
        ? ((e = t.match(/[\\?&]v=([^&#]*)/)[1]),
          (i =
            t.indexOf("list=") > 0 ? t.match(/[\\?&]list=([^&#]*)/)[1] : null))
        : (i = (e = t.length > 15 ? null : t) ? null : t),
    ...
    (jQuery.mbYTPlayer = {
                        ...
                        : void new YT.Player(playerID, {
                            ...
                            events: {
                                    ...
                                    (YTPlayer.checkForStartAt = setInterval(
                                      function () {
                                        var t =
                                          ...
                                          e / YTPlayer.player.getDuration();
                                        YTPlayer.player.getDuration() > 0 &&
                                        YTPlayer.player.getCurrentTime() >= e &&
                                        t
                                          ? (clearInterval(
                              ...
                              onStateChange: function (event) {
                                if (
                                  "function" ==
                                  typeof event.target.getPlayerState
                                ) {
      ...
      getDataFromFeed: function (t) {
        jQuery.browser.msie && jQuery.browser.version < 9
          ? ("auto" == t.opt.ratio ? (t.opt.ratio = "16/9") : t.opt.ratio,
            t.hasData ||
              ((t.hasData = !0),
              setTimeout(function () {
          ...
          : (jQuery.getJSON(
              ...
              function (e) {
                ...
                for (var n in ((i.prop = {}), t.videoData))
                  i.prop[n] = t.videoData[n];
                if (
                  (jQuery(t).trigger(i),
                  (t.title = t.videoData.title),
                  "auto" == t.opt.ratio &&
                    (t.opt.ratio =
                      ...
                      "widescreen" === t.videoData.aspectRatio
                        ? "16/9"
                        : "4/3"),
                  !t.hasData && ((t.hasData = !0), t.isPlayer))
                ) {
            ...
            setTimeout(function () {
              t.dataReceived ||
                t.hasData ||
                ((t.hasData = !0), jQuery(t).trigger("YTPChanged"));
            }, 1500));
      },
      ...
      changeMovie: function (t) {
        ...
        if (
          (jQuery(e.playerEl).CSSAnimate({ opacity: 0 }, i),
          setTimeout(function () {
            ...
            jQuery(e)
              ...
              jQuery(e).one("YTPStart", function () {
                e.wrapper.CSSAnimate(
                  ...
                  jQuery(e.playerEl).CSSAnimate({ opacity: 1 }, i),
      ...
      setYTPVolume: function (t) {
        ...
        t || e.opt.vol || 0 != e.player.getVolume()
          ? (!t && e.player.getVolume() > 0) || (t && e.player.getVolume() == t)
          ...
          (t.getState = setInterval(function () {
            ...
            if (
              ...
              0 == t.player.getVolume()
                ? i.addClass("isMuted")
                : i.removeClass("isMuted"),
              t.opt.showControls &&
                (e.totalTime
                  ? n
                      .find(".mb_YTVPTime")
                      .html(
                        jQuery.mbYTPlayer.formatTime(e.currentTime) +
                          " / " +
                          jQuery.mbYTPlayer.formatTime(e.totalTime)
                      )
                  : n.find(".mb_YTVPTime").html("-- : -- / -- : --")),
              document.hasFocus()
                ? document.hasFocus() &&
                  !t.hasFocus &&
                  ((t.hasFocus = !0), i.playYTP())
                : 1 == t.state && ((t.hasFocus = !1), i.pauseYTP()),
              1 == t.player.getPlayerState() &&
                (parseFloat(t.player.getDuration() - 3) <
                  t.player.getCurrentTime() ||
                  (s > 0 && parseFloat(t.player.getCurrentTime()) > s)))
            ) {
              if (t.isEnded) return;
              if (
                ((t.isEnded = !0),
              ...
              r.loop
                ? t.player.seekTo(o, !0)
                : (t.player.pauseVideo(),
                  t.wrapper.CSSAnimate({ opacity: 0 }, 1e3, function () {
                    var e = jQuery.Event("YTPEnd");
                    if (
                      ((e.time = t.player.time),
                      jQuery(t).trigger(e),
                      t.player.seekTo(o, !0),
                      !t.isBackground)
                    ) {
        ...
        if (!0 !== this.stop) {
          ...
          n.timeout = setTimeout(function () {
            ...
            if ("^" === r.charAt(0)) {
              var o = 1;
              /^\^\d+/.test(r) &&
                ((o += (r = /\d+/.exec(r)[0]).length), (i = parseInt(r))),
            ...
            if ("html" === n.contentType) {
              ...
              if ("<" === s || "&" === s) {
                ...
                for (
                  l = "<" === s ? ">" : ";";
                  t.substr(e + 1).charAt(0) !== l &&
                  (t.substr(e).charAt(0), !(1 + ++e > t.length));
  ...
  (function (t) {
    ...
    var i = ':input:not([type="submit"], button):enabled:visible',
      n = function (e, i) {
        for (var r in ((this.$element = t(e)),
        (this.options = i),
        (i.errors = t.extend({}, n.DEFAULTS.errors, i.errors)),
        i.custom))
          if (!i.errors[r])
            throw new Error(
              "Missing default error message for custom validator: " + r
            );
    ...
    (n.DEFAULTS = {
      ...
      (n.prototype.validateInput = function (e) {
        ...
        if (
          (i.is('[type="radio"]') &&
            (i = this.$element.find('input[name="' + i.attr("name") + '"]')),
          this.$element.trigger(
            (e = t.Event("validate.bs.validator", { relatedTarget: i[0] }))
          ),
          !e.isDefaultPrevented())
        ) {
          var r = this;
          this.runValidators(i).done(function (o) {
            i.data("bs.validator.errors", o),
              o.length ? r.showErrors(i) : r.clearErrors(i),
              (n && o.toString() === n.toString()) ||
                ((e = o.length
              ...
              r.toggleSubmit(),
              r.$element.trigger(
                t.Event("validated.bs.validator", { relatedTarget: i[0] })
              );
          });
        }
      }),
      ...
      (n.prototype.showErrors = function (e) {
        ...
        this.defer(e, function () {
          ...
          s.length &&
            ...
            void 0 === r.data("bs.validator.originalContent") &&
              r.data("bs.validator.originalContent", r.html()),
            r.empty().append(s),
